...
2. **Load focused guidance** - Use the Skill tool to invoke `/backend-patterns` for backend layering and request-flow guidance, and `/coding-guardrails` for assumptions, simplicity, surgical diffs, and verification.
