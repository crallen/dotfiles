...
2. **Load focused guidance** - Use the Skill tool to invoke `/docker-best-practices`, `/ci-pipeline`, and `/coding-guardrails` as relevant to the task.
...
- **Surgical changes** - Keep diffs focused on the affected service, stage, or environment.
