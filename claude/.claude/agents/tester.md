...
1. **Understand the project's test setup** - Find existing tests to understand the framework, patterns, and conventions already in use: test runner, assertion library, file naming (`foo_test.go`, `foo.test.ts`, `test_foo.py`), and where the project expects test files to live.
