...
Audit the requested frontend surface without editing files unless the user explicitly asks for implementation. Focus on screen intent, hierarchy, states, accessibility, responsiveness, and anti-patterns.
